...
public class VenueRepository {
    ...
    public LiveData<Resource<List<Venue>>> getVenues(String venueType, String latLng) {
        ...
        LiveData<ApiResponse<VenueListResponse>> apiResponseLiveData = webService.getVenuesApiResponse(venueType, latLng);

        System.out.println("VenueRepository apiResponseLiveData: " + apiResponseLiveData.getValue());
    ...
    public LiveData<ApiResponse<VenueListResponse>> getVenuesApiResponse(String venueType, String latLng) {
        return webService.getVenuesApiResponse(venueType, latLng);
    }
}
