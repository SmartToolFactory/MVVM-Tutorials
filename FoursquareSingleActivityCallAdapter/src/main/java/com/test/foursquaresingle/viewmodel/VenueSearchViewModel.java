...
public class VenueSearchViewModel extends ViewModel {
    ...
    public MediatorLiveData<ApiResponse<VenueListResponse>> apiResponseMediatorLiveData = new MediatorLiveData<>();
...
//        System.out.println("VenueSearchViewModel mVenueListData: " + mVenueListData);
        ...
        apiResponseMediatorLiveData.addSource(queryLiveData, new Observer<Query>() {
            @Override
            public void onChanged(@Nullable Query query) {

                System.out.println("VenueSearchViewModel onChanged() query: " + query);

                LiveData<ApiResponse<VenueListResponse>> apiResponseLiveData = venueRepository.getVenuesApiResponse(query.venueType, query.venueLocation);

                apiResponseMediatorLiveData.addSource(apiResponseLiveData, new Observer<ApiResponse<VenueListResponse>>() {
                    @Override
                    public void onChanged(@Nullable ApiResponse<VenueListResponse> venueListResponseApiResponse) {
                        System.out.println("VenueSearchViewModel onChanged()2 venueListResponseApiResponse: " + venueListResponseApiResponse);
